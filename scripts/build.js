...
const dialAppConfig = require('../speed-dial-app/config/webpack.config.prod');
const dialAppPaths = require('../speed-dial-app/config/paths');

const optionsAppConfig = require('../options-app/config/webpack.config.prod');
const optionsAppPaths = require('../options-app/config/paths');
...
function buildWithConfig(paths, configs) {
